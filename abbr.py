...
###
length = marker.find(marker[-1], -1)
first_marker = line.find(marker)
first_half = line[:first_marker]
second_half = line[first_marker + length + 1:]

replaced = first_half + replacement + second_half
